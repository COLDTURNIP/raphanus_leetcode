...
mod tests {
    ...
    #[test]
    fn test_all_equal() {
        assert_eq!(Solution::wiggle_max_length(vec![5; 99]), 1);
    }

    #[test]
    fn test_short() {
        assert_eq!(Solution::wiggle_max_length(Vec::new()), 0);
        assert_eq!(Solution::wiggle_max_length(vec![8]), 1);
        assert_eq!(Solution::wiggle_max_length(vec![7, 7]), 1);
    }

    #[bench]
    fn bench(b: &mut test::Bencher) {
        b.iter(|| Solution::wiggle_max_length(vec![1, 17, 5, 10, 13, 15, 10, 5, 16, 8]));
    }
}
